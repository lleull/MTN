...
const AboutComponent = () => {
  return (
    <div className="w-full pl-24 h-72 pb-24 pr-24 bg-bgcustom flex flex-row items-start   justify-between">
      ...
      <div className="flex flex-col items-start gap-5">
        <h2 className="text-xl font-chronic text-orangeLine">More on our Blog</h2>
        <h3>About MTN</h3>
      ...
      <div className="flex flex-col items-start gap-5">
        <h2 className="text-xl font-chronic text-orangeLine">More on MTN</h2>
        <h3>The team</h3>
        <h3>Jobs</h3>
        <h3>Press</h3>
      </div>
